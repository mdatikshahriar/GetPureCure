...
public class SmallBlogAdapter extends RecyclerView.Adapter <RecyclerView.ViewHolder> {

    private Context context;

    private ArrayList<Blog> blogArray;

    public SmallBlogAdapter(Context context, ArrayList<Blog> blogArray) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_small_blog, parent, false);
        return new SmallBlogAdapter.BlogHolder(view);
    }
    ...
    private class BlogHolder extends RecyclerView.ViewHolder {
        ...
        BlogHolder(View itemView) {
            ...
            blogTitleImageView = itemView.findViewById(R.id.item_small_blog_blogTitle_ImageView);
            blogBodyLinearLayout = itemView.findViewById(R.id.item_small_blog_blogBody_LinearLayout);
            blogTitleTextView = itemView.findViewById(R.id.item_small_blog_blogTitle_TextView);
            blogDateTextView = itemView.findViewById(R.id.item_small_blog_blogDate_TextView);
            blogLikeTextView = itemView.findViewById(R.id.item_small_blog_blogLike_TextView);
            blogCommentTextView = itemView.findViewById(R.id.item_small_blog_blogComment_TextView);
